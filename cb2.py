...
def greet_user():
    ...
    print(f"Maveli: Namaskaram, {user_name}! How can I help you? If you have any questions for me, type 'questions'. If you need to change the language, type 'language'. If you want to exit, type 'bye'.\n")
...
def main():
    global user_name  # Make user_name a global variable

    greet_user()  # Call greet_user to initialize user_name
